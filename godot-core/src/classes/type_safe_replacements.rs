...
impl SceneTree {
    ...
    pub fn call_group_flags(
        ...
        self.raw_call_group_flags(
            crate::builtin::to_i64_from_u64(flags.ord()),
            group,
            method,
            varargs,
        )
    ...
    pub fn set_group_flags(
        ...
        self.raw_set_group_flags(
            crate::builtin::to_u32(call_flags.ord()),
            group,
            property,
            value,
        )
